...
/// <summary>
/// Handler for ListAtendimentosByCpfQuery.
/// </summary>
public sealed class ListAtendimentosByCpfQueryHandler : IQueryHandler<ListAtendimentosByCpfQuery, IReadOnlyList<AtendimentoDto>>
{
    private readonly string _connectionString;

    public ListAtendimentosByCpfQueryHandler(IConfiguration configuration)
    {
    ...
    public async Task<IReadOnlyList<AtendimentoDto>> HandleAsync(ListAtendimentosByCpfQuery query, CancellationToken cancellationToken = default)
    {
        const string sql = @"
            SELECT 
        ...
        command.Parameters.AddWithValue("@Cpf", query.Cpf);
