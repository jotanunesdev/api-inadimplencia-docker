...
/// <summary>
/// Handler for ListOcorrenciasQuery.
/// </summary>
public sealed class ListOcorrenciasQueryHandler : IQueryHandler<ListOcorrenciasQuery, IReadOnlyList<OcorrenciaDto>>
{
    private readonly string _connectionString;

    public ListOcorrenciasQueryHandler(IConfiguration configuration)
    {
    ...
    public async Task<IReadOnlyList<OcorrenciaDto>> HandleAsync(ListOcorrenciasQuery query, CancellationToken cancellationToken = default)
    {
        const string sql = @"
            SELECT 
